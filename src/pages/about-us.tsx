    ...
    <Layout>
      ...
      <article className="">
        ...
        <div className="bg-white relative py-36 px-20 w-3/5 -mt-40 z-30">
          ...
          <p className="pt-12">
            Open Source Community Africa (O.S.C.A) is for open source lovers, enthusiasts, advocates and experts within
      ...
      <article className="flex items-end mt-64">
        <div className="bg-white relative py-20 w-1/2 px-20 -mr-40 -mb-40 z-30">
          ...
          <p className="pt-12">
            ...
            <br />
            <br />
            Take African developers from the billion users to the billion creators; We hope to do this with our monthly
            OSCA meetups across different chapters.
            <br />
            <br />
